"""
Django settings for mess_balance project.
...
SECRET_KEY = 'coi2dlged9*wqel%#dc_+uf-rn#)7m1%1f#)y^y%(0&pbi#$1^'
...
ROOT_URLCONF = 'mess_balance.urls'
...
WSGI_APPLICATION = 'mess_balance.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backup.backends.postgresql_psycopg2',
        'NAME': 'mess',
        'USER': 'postgres',
        'PASSWORD': '1919',
        'HOST': 'localhost',
